  ...
  switch (type) {
    ...
    case JUGADA_SELECCIONADA:
      return {
        ...
        jugadorUno: {
          ...state.jugadorUno,
          jugadaActual: {
            ...state.jugadorUno.jugadaActual,
            image: payload.imagenJugada,
    ...
    case SUMAR_PUNTOS_GANADOR_MULTIPLAYER:
      ...
      return {
        ...
        jugadorUno: {
          ...state.jugadorUno,
          ganados: state.jugadorUno.ganados + puntosJugadorUno,
        },
        jugadorDos: {
          ...state.jugadorDos,
